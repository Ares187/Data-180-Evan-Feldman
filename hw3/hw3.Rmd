...
ggplot(Cars93, aes(x=EngineSize, y=MPG.city)) +
  ...
  labs(y= 'Miles Per Gallon in a City', x = 'Engine Size', title = 'Engine Size vs MPG', subtitle = 'In Cities', caption = 'negative trend')
```
...
```{r}
ggplot(Cars93, aes(x=EngineSize, y=MPG.city, col = Type)) +
  geom_point(size = 2) + 
  labs(y= 'Miles Per Gallon in a City', x = 'Engine Size', title = 'Engine Size vs MPG', subtitle = 'In Cities', caption = 'negative trend')
```
...
ggplot(Cars93, aes(x=EngineSize, y=MPG.city, col = Type)) +
  geom_point(size = 2) + 
  labs(y= 'Miles Per Gallon in a City', x = 'Engine Size', title = 'Engine Size vs MPG', subtitle = 'In Cities', caption = 'negative trend') +
  geom_smooth(col = 'red', linetype = 'dashed')
#not sure how to remove the shading and just have the line
```
...
ggplot(Cars93, aes(x=AirBags, fill = AirBags)) +
  geom_bar() + 
  labs(y= 'count', x = 'Airbags', title = 'Car Count of Airbags', subtitle = 'Distribution of airbags', caption = 'Cars93 data')
```
...
ggplot(Cars93, aes(x=Origin, fill = AirBags)) +
  ...
  labs(y= 'count', x = 'Airbags', title = 'Car Count of Airbags', subtitle = 'Distribution of airbags by origin', caption = 'Cars93 data')
```
...
```{r}
ggplot(au_states)+geom_sf() + geom_point(data = au_capitals, aes(x = lon, y = lat), col = 'red', size = 2)
...
```{r}
ggplot(au_states)+geom_sf() + geom_point(data = au_capitals, aes(x = lon, y = lat), col = 'red', size = 2) + coord_sf(crs = st_crs(3112))
